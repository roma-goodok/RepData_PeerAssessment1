...
Mean of total number of steps taken per day is `r mean.per.day`
Median of total number of steps taken per day is `r median.per.day`
...
5-minute interval, which contains the maximum number of average steps across all the days is `r max.interval$interval` (r max.interval$time)  
maximum number of avarage steps across all the days is `r max.avg.steps`
...
Mean of total number of steps taken per day is `r mean.per.day.p`
Median of total number of steps taken per day is `r median.per.day.p`
